...
plan = DataAccessPlan(EPAAQS.Source(), (0.0, 0.0),
...
|---------|------|---------|-------------|
| `service` | `EPAService.T` | `EPAService.dailyData` | `EPAService.sampleData`, `EPAService.dailyData`, or `EPAService.annualData` |
